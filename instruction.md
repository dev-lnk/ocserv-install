В репозитории будет файл ssl.sh, install.sh и ocserv.conf. Пользователь выполнит клонирования репозитория и выполнит install.sh. Вот что примерно должно быть в данном файле
